...
const PrivacyPolicy = () => {
    return (
        <CommonLegalTemplate
            ...
            pageUpdatedOn="updated on 26 May, 2020"
        >
            <Paragraph>
                This privacy policy (“Policy”) describes how SELLSAGE LLC
                (“SELLSAGE LLC”, “we”, “us” or “our”) collects, protects and
            ...
            <Heading3>Automatic collection of information</Heading3>
            ...
            <Heading3>Collection of personal information</Heading3>
            ...
            <Paragraph>
                ...
                a specific, identifiable individual. If, however, you wish to
                use some of the Website’s features, you may be asked to provide
                ...
                a purchase, or fill any online forms on the Website. When
            ...
            <Heading3>Managing personal information</Heading3>

            <Paragraph>
                You are able to delete certain Personal Information we have
                about you. The Personal Information you can delete may change as
                the Website or Services change. When you delete Personal
            ...
            <Heading3>Storing personal information</Heading3>
            ...
            <Heading3>Use and processing of collected information</Heading3>

            <Paragraph>
                In order to make our Website and Services available to you, or
                ...
                media, emails, etc. Any of the information we collect from you
                may be used for the following purposes:
            </Paragraph>

            <ul>
                <li>Create and manage user accounts etc.</li>
            ...
            <Paragraph>
                ...
                with our Website, where you are located in the world and if one
                of the following applies: (i) You have given your consent for
            ...
            <Heading3>Information transfer and storage</Heading3>
            <Paragraph>
            ...
            <Heading3>The rights of users </Heading3>
            <Paragraph>
            ...
            <Heading3>The right to object to processing</Heading3>
            <Paragraph>
            ...
            <Heading3>How to exercise these rights</Heading3>
            <Paragraph>
                Any requests to exercise User rights can be directed to SELLSAGE
                LLC through the contact details provided in this document. These
                requests can be exercised free of charge and will be addressed
                by SELLSAGE LLC as early as possible.
            </Paragraph>

            <Heading3>California privacy rights</Heading3>
            <Paragraph>
            ...
            <Paragraph>
                ...
                the latest security standards as managed by the PCI Security
                Standards Council, which is a joint effort of brands like Visa,
                MasterCard, American Express and Discover. Sensitive and private
                data exchange happens over a SSL secured communication channel
                and is encrypted and protected with digital signatures, and our
                Website is also in compliance with PCI vulnerability standards
            ...
            <Heading3>Product and service providers</Heading3>
            <Paragraph>
                We may contract with other companies to provide certain products
                and services. These service providers are not authorized to use
                ...
                share Personal Information for these purposes only with
                third-parties whose privacy policies are consistent with ours or
                who agree to abide by our policies with respect to Personal
            ...
            <Heading3>Privacy of children </Heading3>
            <Paragraph>
                ...
                Website or Service. We encourage parents and legal guardians to
                ...
                Information through our Website or Service without their
                permission.
            </Paragraph>
            <Paragraph>
                If you have reason to believe that a child under the age of 13
                has provided Personal Information to us through our Website or
                Service, please contact us. You must also be at least 16 years
                of age to consent to the processing of your Personal Information
                in your country (in some countries we may allow your parent or
                guardian to do so on your behalf).
            </Paragraph>

            <Heading3>Newsletters </Heading3>
            <Paragraph>
            ...
            <Paragraph>
                ...
                features of the Website and Services. To learn more about
                cookies and how to manage them, visit internetcookies.org
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
                For further information on how we use cookies, please read our
                <Link href="/legal/cookie-policy" passHref>
                    <a> cookie policy.</a>
                </Link>
            </Paragraph>

            <Heading3>Do Not Track signals </Heading3>
            <Paragraph>
                ...
                As a result, this Website is not yet set up to interpret or
                respond to Do Not Track signals communicated by your browser.
            ...
            <Paragraph>
                ...
                for the privacy practices of such other websites or
            ...
            <Heading3>Legal disclosure </Heading3>
            <Paragraph>
                ...
                and Personal Information will likely be among the assets
                transferred.
            </Paragraph>
            ...
            <Paragraph>
                ...
                you agree to be bound by this Policy. If you do not agree to
                abide by the terms of this Policy, you are not authorized to use
            ...
            <Paragraph>
                ...
                email to connect@sellsage.com or write a letter to 41150 Van
                Born Road, Canton, MI, 48188, USA
            </Paragraph>
        </CommonLegalTemplate>
    )
}
